    ...
    <Flex direction="column" minH="100vh" bg="#FFFFFF" color="gray.800">
      ...
      <Box flex="1">
        <Routes>
          ...
          <Route
            path="/login"
            element={isLoggedIn ? isAdmin ? <Navigate to="/admin" replace /> : <Navigate to="/tracker" replace /> : <Login />}
          />
          ...
          <Route
            path="/profile"
            element={isLoggedIn ? isAdmin ? <Navigate to="/admin" replace /> : <Profile /> : <Navigate to="/login" replace />}
          />
